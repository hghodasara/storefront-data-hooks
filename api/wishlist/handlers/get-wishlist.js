...
var getWishlist = function (_a) {
    var res = _a.res, _b = _a.body, customerToken = _b.customerToken, includeProducts = _b.includeProducts, config = _a.config;
    return __awaiter(void 0, void 0, void 0, function () {
        var result, customerId, _c, wishlist;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    _e.label = 4;
                case 4:
                    res.status(200).json({ data: (_d = result.data) !== null && _d !== void 0 ? _d : null });
                    return [2 /*return*/];
            }
        });
    });
};
exports.default = getWishlist;
