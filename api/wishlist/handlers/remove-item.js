...
var removeItem = function (_a) {
    var res = _a.res, _b = _a.body, customerToken = _b.customerToken, itemId = _b.itemId, config = _a.config;
    return __awaiter(void 0, void 0, void 0, function () {
        var customerId, _c, wishlist, _d, result, data;
        var _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, config.storeApiFetch("/v3/wishlists/" + wishlist.id + "/items/" + itemId, { method: 'DELETE' })];
                case 5:
                    result = _f.sent();
                    data = (_e = result === null || result === void 0 ? void 0 : result.data) !== null && _e !== void 0 ? _e : null;
