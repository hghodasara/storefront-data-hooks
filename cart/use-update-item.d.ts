...
declare function extendHook(customFetcher: typeof fetcher, cfg?: {
    ...
    (item: PhysicalItem, params?: {
        options: FetcherOptions;
    } | undefined): import("lodash").DebouncedFunc<(input: UpdateItemInput) => Promise<Cart | null>>;
    extend: typeof extendHook;
};
declare const _default: {
    (item: PhysicalItem, params?: {
        options: FetcherOptions;
    } | undefined): import("lodash").DebouncedFunc<(input: Partial<{
        id: string;
